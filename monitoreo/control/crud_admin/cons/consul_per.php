    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <div class="container-fluid">
                <span class="navbar-brand mb-0 h1">Administrador | Gestion de Personal registrado</span>
            </div>
        </nav>
        ...
        <thead class="thead-dark">
            ...
            $sqlCon = "select * from persona order by id_persona asc";
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        <form action="../elim/elim_perso.php" method="POST">
                            <input type="hidden" name="id_per" value=<?php echo $id_per ?>>
                            <button type="submit" class="btn btn-danger">eliminar</button>
                        </form>
                    </td>
                    <td>
                        <form action="../actu/actu_per.php" method="POST">
                            <input type="hidden" name="id_per" value=<?php echo $id_per ?>>
